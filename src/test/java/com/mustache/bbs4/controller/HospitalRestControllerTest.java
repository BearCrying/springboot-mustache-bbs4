...
//@WebMvcTest : Controller를 테스트 하게 해주는 기능
class HospitalRestControllerTest {
    ...
    @MockBean
    //@Autowired 아님  -->HospitalService는 테스트를 위해 가짜 객체를 쓰겠다는 뜻.
    // 가짜 객체를 쓰면 좋은 점 : DB와 상관없이 테스트 가능
    HospitalService hospitalService;

    @Test
    @DisplayName("한 개의 json형태로 Response가 잘 오는지")
